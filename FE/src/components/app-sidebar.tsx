...
import { Compass, FileText, BarChart3, PanelLeft, Crown, LogOut } from "lucide-react"
      ...
      <aside className={cn(
            ...
            <div className="px-4 pb-3">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-3 w-full rounded-lg hover:bg-white/5 p-1 transition-colors">
        ...
        {!isAppSidebarOpen && (
          <div className="p-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="w-full p-2 hover:bg-white/10 rounded-md transition-colors" title="프로필">
